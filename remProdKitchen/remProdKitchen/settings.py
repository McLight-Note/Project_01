"""
Django settings for remProdKitchen project.
...
SECRET_KEY = os.environ.get('SECRET_KEY', "django-insecure-x5a)kmk5gw+atq-6@+6q#c_=@nnai^($d*_&a3bs1sg%+8k__#")
